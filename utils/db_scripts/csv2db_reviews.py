...
f = open('../crawler/data/reviews/떡볶이리뷰.csv', 'r', encoding='utf-8')
...
for row in tqdm(csvReader):
    ...
    (prod_name, rating, title, context, answer, review_url) 
    VALUES (%s, %s, %s, %s, %s, %s)"""

    curs.execute(sql, (prod_name, rating, title, context, answer, review_url))
    # print(row, "삽입 완료")

...
#         product_name = '떡볶이'
#
#         file_path = f"./product_{product_name}_ver5.csv"
...
#
#         # 파일에 쓸 데이터 준비
#         csv_columns = ['prod_name', 'user_name', 'rating', 'headline', 'review_content', 'answer', 'helped_cnt', 'survey', 'top100_yn']
#         # 서울 시간
#         now = datetime.now(timezone('Asia/Seoul'))
#         # 파일 이름
#         # csv_file = f'../reviews/{product_name}_{now.strftime("%y%m%d_%H")}.csv'
#         csv_file = f'./review_{product_name}_ver5.csv'
#

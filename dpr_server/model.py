...
class DenseRetriever:
    ...
    def run_dpr_db(self, query: str, reviews: List[str]) -> str:
        start = time.time()
    ...
    def run_dpr_db_v3(self, query: str, reviews: List[str]) -> str:
        ...
        recom_list = [
            ...
            {
                "prod_id": prod_ids[sort_indices[3]],
                "context": filtered_reviews[sort_indices[3]],
            },
            {
                "prod_id": prod_ids[sort_indices[4]],
                "context": filtered_reviews[sort_indices[4]],
            },
        ]
